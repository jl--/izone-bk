;
'use strict';
angular.module('app', ['ui.router','ui.bootstrap','app.auth', 'app.config', 'app.resource', 'app.utils','ngAnimate','angularFileUpload','ngImgCrop'])
    .config(['$stateProvider', '$urlRouterProvider', '$animateProvider',
        function($stateProvider, $urlRouterProvider, $animateProvider) {
            ...
            .state('admin.portfolio',{
                url: 'portfolio',
                resolve:{
                    portfolio: ['Portfolio',function(Portfolio){
